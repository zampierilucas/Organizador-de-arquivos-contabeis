...
public class log {
	 ...
	 public static void File(BufferedWriter bw, String  EmpresaNome, String TipoFile, String SourcePath, String DestPath) throws IOException {
    ...
    public static void statystics(int iteracaoComSucesso, int iteracaoComErros, int iteracaoTotal, String logPath) throws IOException {
        String input = "";
